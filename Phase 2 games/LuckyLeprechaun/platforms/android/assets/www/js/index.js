...
var app = {
  ...
  /*  url : '',
    ...
    onDeviceReady: function() {
        ...
        // Android banner tag																												  
     //    app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/luckyleprechaun/en?&Bannertag1=w32361c847p015b11372d&bannertag2=2&ispracticeplay=false";
    
      if(bannertag == ""){
        	app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/luckyleprechaun/en?&Bannertag1=w32361c847p015b11372d&bannertag2=2&ispracticeplay=false";
        }else{
        	app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/luckyleprechaun/en?&Bannertag1="+bannertag+"&bannertag2=2&ispracticeplay=false";
        }
