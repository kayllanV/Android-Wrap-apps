  ...
  /*  url : '',
    ...
    onDeviceReady: function() {
     ...
     if(bannertag == ""){
        	...
        	app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/5ReelDrive/en?&Bannertag1="+bannertag+"&bannertag2=2&ispracticeplay=false";
        }
