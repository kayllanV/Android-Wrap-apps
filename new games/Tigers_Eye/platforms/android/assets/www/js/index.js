...
var app = {
  ...
  /*  url : '',
    ...
    onDeviceReady: function() {
        ...
        if(bannertag == ""){
        	app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/TigersEye/en?&Bannertag1=w32361c847p027b11372d&bannertag2=2&ispracticeplay=false";
        }else{
        	app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/TigersEye/en?&Bannertag1="+bannertag+"&bannertag2=2&ispracticeplay=false";
        }
