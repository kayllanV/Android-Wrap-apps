...
var app = {
  ...
  /*  url : '',
    ...
    onDeviceReady: function() {
        ...
        if(bannertag == ""){
        	app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/BikiniParty/en?&Bannertag1=w32361c847p025b11372d&bannertag2=2&ispracticeplay=false";
        }else{
        	app.url = "https://mobile2.gameassists.co.uk/MobileWebServices_40/casino/game/launch/CrazyVegas/BikiniParty/en?&Bannertag1="+bannertag+"&bannertag2=2&ispracticeplay=false";
        }
